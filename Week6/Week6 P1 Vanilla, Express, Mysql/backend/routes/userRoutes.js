...
router.post('/signup', upload.single('profileImage'), postSignup); // 회원가입 라우트
...
router.patch('/update1', upload.single('profileImage'), updateUser); // 사용자 정보 업데이트 라우트 (프로필 이미지 포함)
