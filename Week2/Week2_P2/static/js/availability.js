document.addEventListener('DOMContentLoaded', (event) => {    
    ...
    let inputProfileImageValid = false;
    ...
    function updateSignupButtonStatus() {
        ...
        if (inputEmailValid && inputPasswordValid && inputRetypePasswordValid && inputNicknameValid && inputProfileImageValid) {
